  ...
  return (
    <>
      <Link
        ...
        className="max-w-[1200px] p-1.5 border border-gray-50 hover:border-gray-200 hover:shadow-xl bg-gray-100 rounded mx-auto hover:bg-slate-500/40 hover:text-slate-600 duration-300"
      >
        {product?.url ? (
